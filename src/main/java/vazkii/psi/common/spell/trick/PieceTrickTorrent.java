 ...
 * 1.7.10 Backport: Based on Psi-1.21.1/src/main/java/vazkii/psi/common/spell/trick/PieceTrickTorrent.java:1
 * Modern: Level water creation. GTNH: World.setBlock water.
 */
...
public class PieceTrickTorrent extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        if (context.focalPoint.worldObj.isAirBlock(pos.x, pos.y, pos.z)) {
            context.focalPoint.worldObj.setBlock(pos.x, pos.y, pos.z, Blocks.water);
        }
        return null;
    }
}
