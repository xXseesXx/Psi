 ...
 * 1.7.10 Backport: Based on Psi-1.21.1/src/main/java/vazkii/psi/common\spell\trick\block\PieceTrickPlaceBlock.java:34
 * GTNH: World.setBlock from inventory BlockItem.
 */
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        if (stack != null && stack.getItem() instanceof ItemBlock) {
            ...
            if (context.focalPoint.worldObj.isAirBlock(pos.x, pos.y, pos.z)) {
                // GTNH: 1.7.10 setBlock needs meta + flag 3 for client sync (was 3-arg, no notify → desync)
                context.focalPoint.worldObj.setBlock(pos.x, pos.y, pos.z, block, meta, 3);
                context.focalPoint.worldObj.markBlockForUpdate(pos.x, pos.y, pos.z);
