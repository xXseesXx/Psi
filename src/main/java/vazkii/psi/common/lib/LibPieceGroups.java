 ...
 * 1.7.10 Backport: Based on Psi-1.21.1/src/main/java/vazkii/psi/common/lib/LibPieceGroups.java:15
 * Modern uses net.minecraft.resources.ResourceLocation + ResourceKey. In 1.7.10 we use
 * net.minecraft.util.ResourceLocation and Psi.location() shim.
 */
