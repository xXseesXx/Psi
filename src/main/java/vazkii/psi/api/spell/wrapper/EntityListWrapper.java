 ...
 * 1.7.10 Backport: Based on Psi-1.21.1/src/main/java/vazkii/psi/api/spell/wrapper/EntityListWrapper.java:1
 * GTNH adaptation: Entity net.minecraft.world.entity -> net.minecraft.entity; getId() -> getEntityId();
 * remove @NotNull.
 */
...
public class EntityListWrapper implements Iterable<Entity> {
    ...
    private EntityListWrapper(List<Entity> list) {
     ...
     */
    public static EntityListWrapper make(List<Entity> list) {
    ...
    public static EntityListWrapper union(EntityListWrapper left, EntityListWrapper right) {
    ...
    public static EntityListWrapper exclusion(EntityListWrapper list, EntityListWrapper remove) {
    ...
    public static EntityListWrapper intersection(EntityListWrapper left, EntityListWrapper right) {
        List<Entity> result = new ArrayList<>();
        for (Entity e : left) {
    ...
    public static EntityListWrapper withAdded(EntityListWrapper base, Entity toAdd) {
    ...
    public static EntityListWrapper withRemoved(EntityListWrapper base, Entity toRemove) {
        List<Entity> list = new ArrayList<>(base.list);
    ...
    public static int compareEntities(Entity l, Entity r) {
        return Integer.compare(l.getEntityId(), r.getEntityId());
    }
