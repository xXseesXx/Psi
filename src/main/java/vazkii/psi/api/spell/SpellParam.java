 ...
 * 
 * 1.7.10 Backport: Removed all rendering/GUI code. This is pure metadata.
 */
public abstract class SpellParam<T> {
    ...
    // Parameter colors (0xRRGGBB format)
    ...
    /**
     * Gets if this parameter requires a constant ({@link EnumPieceType#CONSTANT}).
     */
    ...
    /**
     * Gets if this parameter can accept the piece passed in. Default implementation
