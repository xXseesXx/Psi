 ...
 * and will show up as an error in it, as well as its {@link #x}, {@link #y} location
 * as a "warning" display next to the piece it indicates.
 * 
 * 1.7.10 Backport: Replaced Pair with simple x,y fields.
 */
