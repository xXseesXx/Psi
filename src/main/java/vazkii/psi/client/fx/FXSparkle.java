...
public class FXSparkle extends EntityFX {
    ...
    private static final ResourceLocation[] TEXTURES = { new ResourceLocation("psi", "textures/particle/sparkle_0.png"),
    ...
    public FXSparkle(World world, double x, double y, double z, float size, float red, float green, float blue,
        int ageMultiplier, double mx, double my, double mz) {
        super(world, x, y, z);
        particleRed = red;
        particleGreen = green;
        particleBlue = blue;
    ...
    public void renderParticle(Tessellator ignored, float partialTicks, float rotationX, float rotationXZ,
        ...
        Minecraft.getMinecraft()
            .getTextureManager()
            .bindTexture(TEXTURES[particleAge % TEXTURES.length]);
    ...
    protected void renderQuad(float partialTicks, float rotationX, float rotationXZ, float rotationZ, float rotationYZ,
        float rotationXY, float scale) {
        ...
        tessellator.addVertexWithUV(
            x - rotationX * quad - rotationYZ * quad,
            y - rotationXZ * quad,
            z - rotationZ * quad - rotationXY * quad,
            1,
            1);
        tessellator.addVertexWithUV(
            x - rotationX * quad + rotationYZ * quad,
